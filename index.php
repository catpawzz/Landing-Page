...
<head>
  ...
  <meta name="description" content="Unleashing Creativity Through Code!">
    <meta name="author" content="💜 Catpawz | Home">
...
<body class="bg-gray-900">
  ...
  <div class="relative isolate overflow-hidden bg-gray-900">
    <div class="absolute inset-0 -z-20 h-full w-full animate-fade animate-duration-[3000ms]">
      <img src="/src/assets/img/femboi-1.JPG" alt="Background Image" class="h-full w-full object-cover opacity-30 ">
    ...
    <div class="mx-auto max-w-7xl px-6 pb-24 sm:pb-32 lg:flex lg:px-8 animate-fade">
      <div class="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
        <div class="mt-24 sm:mt-32 lg:mt-16">
          <a href="https://ko-fi.com/french_femboi" target="_blank" class="inline-flex space-x-6">
            <span class="rounded-full bg-purple-500/10 px-3 py-1 text-sm font-semibold leading-6 text-purple-300 ring-1 ring-inset ring-indigo-500/20">Support me</span>
          </a>
        </div>
